            ...
            <center>
                <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%;">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <a class="btn btn-outline-primary fas fw fa-shoppingcart"
                                href="<?= base_url('booking/tambahBooking/' . $id); ?>"> Booking</a>
                            <span class="btn btn-outline-secondary fas fw fareply" onclick="window.history.go(-1)">
                                Kembali</span>
            </center>
            </p>
        </div>
